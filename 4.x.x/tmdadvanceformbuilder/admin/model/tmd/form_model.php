<?php
  namespace Opencart\Admin\Model\Extension\TmdAdvanceFormbuilder\Tmd;
	class formmodel extends \Opencart\System\Engine\Model {
 	public function addForm($data) {
	$this->db->query("INSERT INTO " . DB_PREFIX . "tmdform set
 	...
 	public function editForm($form_id,$data) {
		$this->db-query("UPDATE ". DB_PREFIX . "tmdform set
			header='".(int)$data['header']."',
			footer='".(int)$data['footer']."',
			button_name='".$this->db->escape($data['button_name'])."',
			custome_style='".$this->db->escape($data['custome_style'])."',
 	...
 	public function deleteForm($form_id){		
		$this->db->query("DELETE FROM" . DB_PREFIX . "tmdform where form_id='".$form_id."'";
		$this->db->query("DELETE FROM" . DB_PREFIX . "tmdform_customergroup WHERE form_id='".$form_id."'");
		$this->db->query("DELETE FROM" . DB_PREFIX . "tmdform_description WHERE form_id='".$form_id."'");
		...
		$this->db->query("DELETE FROM" . DB_PREFIX . "tmdform_notification WHERE form_id='".$form_id."'");
		$this->db->query("DELETE FROM" . DB_PREFIX . "tmdform_product WHERE form_id='".$form_id."'");
		$this->db->query("DELETE FROM" . DB_PREFIX . "tmdform_store WHERE form_id='".$form_id."'");
		$this->db->query("DELETE FROM" . DB_PREFIX . "tmdform_success WHERE form_id='".$form_id."'");		
	} 
