...
class TmdEmailTemplate extends \Opencart\System\Engine\Controller {

	public function index() {
		$this->load->language('extension/tmdadvanceformbuilder/tmd/tmdemailtemplate');
		...
		if(!empty($tmdformbuildermenu_status)){
			...
			$tmdrecord_info = $this->model_extension_tmdadvanceformbuilder_tmd_form->getTmdRecord($forms_id);
			...
			if(isset($tmdrecord_info['store_id'])){
				$store_info = $this->model_extension_tmdadvanceformbuilder_tmd_form->getStore($tmdrecord_info['store_id']);
			}
			...
			$data['sname'] 		= $sname;
			$data['lname'] 		= $lname;
			if(isset($tmdrecord_info['customer_id'])){
			...
			$field_infos = $this->model_extension_tmdadvanceformbuilder_tmd_form->getTmdFieldRecord($filter_data);

			$this->session->data['emailfiles']=[];
	        ...
	        return $this->load->view('extension/tmdadvanceformbuilder/tmd/tmdemailtemplate', $data);
		}
	}
