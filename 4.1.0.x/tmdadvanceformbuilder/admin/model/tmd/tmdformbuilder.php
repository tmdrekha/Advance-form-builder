...
class Tmdformbuilder extends \Opencart\System\Engine\Model {
...
$this->db->query("CREATE TABLE IF NOT EXISTS `".DB_PREFIX."tmdform_description` (
  ...
  `uplaodfilebtn` varchar(255) NOT NULL,
...
$this->db->query("CREATE TABLE IF NOT EXISTS `".DB_PREFIX."tmdform_field_option` (
  ...
  `name` text NOT NULL,
  `image` text NOT NULL,
  `price_prefix` VARCHAR(255) NOT NULL,
...
$this->db->query("CREATE TABLE IF NOT EXISTS `".DB_PREFIX."tmdform_notification` (
  `form_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `customer_notification` int NOT NULL,
  `admin_notification` int NOT NULL,
